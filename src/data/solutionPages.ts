...
export const solutionPages: SolutionPage[] = [
  {
    ...
    seoTitle: 'Build a Custom AI CRM & Quoting System | Naurra.ai',
    description: 'We build custom AI CRM and quoting systems for small businesses on a fixed price, typically in 4-8 weeks. Capture leads, auto-draft branded quotes, and chase follow-ups automatically. See pricing and book a scoping call.',
    keywords: 'custom ai crm development, build a custom crm for small business, ai quoting system development, hire ai crm developer, custom crm build cost, ai crm development company, bespoke crm development small business',
  ...
  },
  {
    ...
    seoTitle: 'Build a Custom AI Invoicing Agent | Naurra.ai',
    description: 'We build custom AI invoicing agents that issue invoices, chase unpaid balances, and reconcile payments. Fixed-price builds, typically 3-6 weeks. See pricing and scope your build.',
    keywords: 'custom ai invoicing agent development, build invoicing automation, hire ai automation developer, invoicing automation build cost, custom accounts receivable automation, invoicing system development small business',
    image: '/blog/ai-agent-custom-crm-quoting-system-small-business.png',
  ...
  },
  {
    ...
    seoTitle: 'Build a Custom AI Lead Capture Agent | Naurra.ai',
    description: 'We build custom AI lead capture agents that listen across Instagram, WhatsApp, email and forms, qualify leads, and route them into one pipeline. Fixed-price builds. Book a scoping call.',
    keywords: 'custom ai lead capture development, build whatsapp lead automation, instagram dm automation development, hire ai lead agent developer, lead qualification system build cost, custom lead routing development',
    image: '/blog/ai-agent-custom-crm-quoting-system-small-business.png',
  ...
  },
  {
    ...
    seoTitle: 'Build a Custom AI Support Email Agent | Naurra.ai',
    description: 'We build custom AI support email agents that triage messages, look up real order data, draft replies in your tone, and escalate only what needs a human. Fixed-price builds. Get a quote.',
    keywords: 'custom ai support agent development, build customer support automation, hire ai support agent developer, support automation build cost, custom helpdesk ai development, support email automation development',
    image: '/blog/ai-agent-custom-crm-quoting-system-small-business.png',
  ...
  },
  {
    ...
    seoTitle: 'Build a Custom AI Appointment Scheduling Agent | Naurra.ai',
    description: 'We build custom AI scheduling agents that book, confirm and reschedule client appointments over WhatsApp, email and voice. Fixed-price builds in 3-5 weeks. Scope your build.',
    keywords: 'custom ai scheduling agent development, build appointment booking automation, hire ai booking agent developer, scheduling automation build cost, custom booking system development',
    image: '/blog/ai-agent-custom-crm-quoting-system-small-business.png',
    ...
    proofMetric: '€15k → €27k monthly revenue in six months',
    proofBody: 'A boutique travel agency using this conversational booking pattern cut itinerary creation from ~3 hours to 20-30 minutes, freed 180+ staff hours a month, and lifted capacity from ~80 to 120-150 bookings monthly without hiring. The same pattern applies to clinics, salons, consultancies, and any service business where booking still happens in message threads.',
  ...
  },
  {
    ...
    seoTitle: 'Build a Custom AI Proposal & SOW Agent | Naurra.ai',
    description: 'We build custom AI proposal and statement-of-work agents that draft scope, pricing and clauses from your past wins. Fixed-price builds. See pricing and book a scoping call.',
    keywords: 'custom ai proposal agent development, build proposal automation, hire ai sow developer, proposal automation build cost, custom document generation development',
    image: '/blog/ai-agent-custom-crm-quoting-system-small-business.png',
