...
export const solutionPages: SolutionPage[] = [
  {
    ...
    seoTitle: 'AI Agent Custom CRM Quoting System for Small Business',
    description: 'AI agent custom CRM quoting system for small business. Capture leads, draft branded quotes from real pricing, and run a lightweight CRM in one fixed-price build.',
  ...
  },
  {
    ...
    seoTitle: 'AI Agent Invoicing and Payment Reminders for Small Business',
    description: 'Custom AI invoicing agent for small business. Issue invoices from real billable triggers, chase unpaid balances, and reconcile payments automatically.',
  ...
  },
  {
    ...
    seoTitle: 'AI Lead Capture and Qualification Agent for Small Business',
    description: 'Custom AI lead capture agent for small business. Capture and qualify leads from Instagram, WhatsApp, email, and forms, then route them into one pipeline.',
  ...
  },
  {
    ...
    seoTitle: 'AI Customer Support Email Agent for Small Business',
    description: 'Custom AI support agent for small business. Triage support emails, look up real order or account data, draft replies in your tone, and escalate only what truly needs a human.',
  ...
  },
  {
    ...
    description: 'Custom AI proposal agent for small business. Read inbound briefs, search past wins, draft scope and pricing in your voice, and output branded proposals fast.',
