...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    seoTitle: 'Travel AI Concierge Case Study: €15k to €27k Monthly Revenue',
    description: 'See how Naurra.ai built an AI travel concierge on WhatsApp and Telegram that cut itinerary creation from 3 hours to 20-30 minutes, saved 180+ staff hours a month, and grew monthly revenue from €15k to €27k.',
    ...
    impact: '€15k → €27k monthly revenue',
    impactDetail: 'Six months after launch, itinerary creation dropped from around 3 hours to 20-30 minutes, freeing over 180 staff hours a month. Capacity rose from about 80 to 120-150 itineraries monthly with no new hires, and monthly revenue grew from roughly €15k to €27k, adding €4.5k-€5k in monthly profit.',
    challengeBullets: [
    ...
    outcomes: [
      'Itinerary creation cut from ~3 hours to 20-30 minutes',
      'Over 180 staff hours freed every month',
      'Capacity up from ~80 to 120-150 itineraries monthly, with no new hires',
      'Monthly revenue grown from ~€15k to ~€27k, adding €4.5k-€5k monthly profit',
      'Clients answered in minutes instead of hours, noticeably improving conversions',
    ],
