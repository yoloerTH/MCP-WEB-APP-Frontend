...
function VoiceAIApp() {
  ...
  return (
    <ProtectedRoute>
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#0a0e1a] relative overflow-hidden">
      ...
      >
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl rounded-3xl shadow-[0_0_80px_-20px_rgba(16,185,129,0.15)] border border-emerald-500/10 overflow-hidden">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl font-display tracking-tight">
                    ...
                    <span className="text-white"> {appMode === 'voice' ? 'Voice' : 'Chat'}</span>
                  </h1>
                  <p className="text-sm text-emerald-400/70 mt-1 font-medium tracking-wide">
                    {appMode === 'voice'
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative" ref={userMenuRef}>
                  <motion.button
                    ...
                    className="p-2 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] hover:border-emerald-500/30 transition-all relative"
                  >
                  ...
                  <AnimatePresence>
                    {showUserMenu && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -10 }}
                        className="absolute right-0 mt-2 w-56 bg-[#0f1423]/95 backdrop-blur-xl rounded-xl border border-white/[0.08] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] overflow-hidden z-50"
                      >
          ...
          {/* Content */}
          <div className="p-8 space-y-6 bg-gradient-to-b from-white/[0.02] to-transparent">
                ...
                {(callStatus === 'listening' || callStatus === 'ai-speaking' || callStatus === 'processing') && (
                  ...
                  >
                    <input
                      ...
                      className="flex-1 px-4 py-3 bg-white/[0.04] text-white placeholder-white/30 rounded-xl border border-white/[0.08] focus:border-emerald-500/50 focus:bg-white/[0.06] focus:outline-none transition-all duration-200"
                    />
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
        ...
        >
          <p className="text-xs text-emerald-400/40 font-medium tracking-wide">
