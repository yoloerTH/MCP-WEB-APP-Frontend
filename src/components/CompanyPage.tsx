...
export default function CompanyPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0e1a] text-white overflow-hidden">
      ...
      {/* ═══════════════════════════════════════════════════════════ */}
      {/* RECOMMENDATION LETTER — Cognitech Group                      */}
      {/* ═══════════════════════════════════════════════════════════ */}
      <section className="relative py-24 lg:py-32">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-100px' }} className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <div className="h-px w-[40px] bg-gradient-to-r from-emerald-500 to-transparent" />
              <span className="text-xs text-emerald-400/60 uppercase tracking-[0.25em] font-semibold">Recommendation</span>
            </div>
            <h2 className="text-3xl lg:text-5xl font-display font-extrabold">
              What clients put{' '}
              <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">in writing.</span>
            </h2>
          </motion.div>
          ...
          <motion.figure
            ...
            viewport={{ once: true, margin: '-80px' }}
            transition={{ duration: 0.5 }}
            className="relative bg-white/[0.03] border border-white/[0.08] rounded-3xl overflow-hidden"
          >
            ...
            {/* Body */}
            <blockquote className="px-7 sm:px-10 py-8 space-y-5 text-gray-300 leading-relaxed">
              <p className="text-sm text-gray-500 uppercase tracking-[0.18em]">To whom it may concern,</p>
              <p>
                This letter confirms our positive working relationship with Athanasios Ioannis
                Panagiotakopoulos, owner of Naurra AI.
              </p>
              <p>
                We partnered with Athanasios on two automation projects: an{' '}
                <a href="/case-studies/automotive-sourcing-engine-profit-automation/" className="text-emerald-400 hover:text-emerald-300 underline decoration-emerald-500/30 underline-offset-4 transition-colors">
                  AI-powered sourcing and profit engine for an automotive reseller
                </a>
                , which has delivered outstanding results, and a{' '}
                <a href="/case-studies/document-intelligence-flight-compensation-eu261-automation/" className="text-emerald-400 hover:text-emerald-300 underline decoration-emerald-500/30 underline-offset-4 transition-colors">
                  document-intelligence pipeline for an EU261 flight-compensation firm
                </a>
                , successfully taken from a stalled build to a working, production-ready system.
              </p>
              <p>
                Across both engagements, Athanasios was reliable, professional, and easy to
                collaborate with, consistently delivering high-quality work on time. We{'’'}re glad to
                recommend him to any business considering working with Naurra AI.
              </p>
            </blockquote>
