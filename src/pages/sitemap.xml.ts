...
const staticPages: SitemapEntry[] = [
  ...
  { loc: `${SITE_URL}/solutions/`, lastmod: '2026-05-01', changefreq: 'weekly', priority: '0.9' },
  { loc: `${SITE_URL}/solutions/ai-crm-quoting-agent/`, lastmod: '2026-05-01', changefreq: 'monthly', priority: '0.9' }
]
